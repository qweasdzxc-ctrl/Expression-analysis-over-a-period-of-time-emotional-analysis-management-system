...
var PathProxy = function() {
  ...
  PathProxy2.prototype.rect = function(x, y, w, h2) {
    this._drawPendingPt();
    this._ctx && this._ctx.rect(x, y, w, h2);
    this.addData(CMD.R, x, y, w, h2);
    return this;
  };
  ...
  PathProxy2.prototype.addData = function(cmd, a, b, c, d, e2, f, g, h2) {
    if (!this._saveData) {
      return;
    }
    var data = this.data;
...
function format(time, template, isUTC, lang) {
  ...
  return (template || "").replace(/{a}/g, a + "").replace(/{A}/g, A + "").replace(/{yyyy}/g, y + "").replace(/{yy}/g, pad(y % 100 + "", 2)).replace(/{Q}/g, q + "").replace(/{MMMM}/g, month[M - 1]).replace(/{MMM}/g, monthAbbr[M - 1]).replace(/{MM}/g, pad(M, 2)).replace(/{M}/g, M + "").replace(/{dd}/g, pad(d, 2)).replace(/{d}/g, d + "").replace(/{eeee}/g, dayOfWeek[e2]).replace(/{ee}/g, dayOfWeekAbbr[e2]).replace(/{e}/g, e2 + "").replace(/{HH}/g, pad(H, 2)).replace(/{H}/g, H + "").replace(/{hh}/g, pad(h2 + "", 2)).replace(/{h}/g, h2 + "").replace(/{mm}/g, pad(m2, 2)).replace(/{m}/g, m2 + "").replace(/{ss}/g, pad(s, 2)).replace(/{s}/g, s + "").replace(/{SSS}/g, pad(S, 3)).replace(/{S}/g, S + "");
}
...
function createSymbol(symbolType, x, y, w, h2, color, keepAspect) {
  ...
  if (symbolType.indexOf("image://") === 0) {
    symbolPath = makeImage(symbolType.slice(8), new BoundingRect_default(x, y, w, h2), keepAspect ? "center" : "cover");
  } else if (symbolType.indexOf("path://") === 0) {
    symbolPath = makePath(symbolType.slice(7), {}, new BoundingRect_default(x, y, w, h2), keepAspect ? "center" : "cover");
  } else {
...
var ECharts = (
  /** @class */
  function(_super) {
    __extends(ECharts3, _super);
    function ECharts3(dom, theme2, opts) {
    ...
    ECharts3.prototype._onframe = function() {
      if (this._disposed) {
        return;
      }
    ...
    ECharts3.prototype.getDom = function() {
      return this._dom;
    };
    ECharts3.prototype.getId = function() {
      return this.id;
    };
    ECharts3.prototype.getZr = function() {
      return this._zr;
    };
    ECharts3.prototype.isSSR = function() {
      return this._ssr;
    };
    ECharts3.prototype.setOption = function(option, notMerge, lazyUpdate) {
    ...
    ECharts3.prototype.setTheme = function() {
      deprecateLog("ECharts#setTheme() is DEPRECATED in ECharts 3.0");
    };
    ECharts3.prototype.getModel = function() {
      return this._model;
    };
    ECharts3.prototype.getOption = function() {
      return this._model && this._model.getOption();
    };
    ECharts3.prototype.getWidth = function() {
      return this._zr.getWidth();
    };
    ECharts3.prototype.getHeight = function() {
      return this._zr.getHeight();
    };
    ECharts3.prototype.getDevicePixelRatio = function() {
      return this._zr.painter.dpr || env_default.hasGlobalWindow && window.devicePixelRatio || 1;
    };
    ECharts3.prototype.getRenderedCanvas = function(opts) {
      if (true) {
        deprecateReplaceLog("getRenderedCanvas", "renderToCanvas");
      }
      return this.renderToCanvas(opts);
    };
    ECharts3.prototype.renderToCanvas = function(opts) {
      opts = opts || {};
    ...
    ECharts3.prototype.renderToSVGString = function(opts) {
      opts = opts || {};
      var painter = this._zr.painter;
      if (true) {
        if (painter.type !== "svg") {
    ...
    ECharts3.prototype.getSvgDataURL = function() {
    ...
    ECharts3.prototype.getDataURL = function(opts) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.getConnectedDataURL = function(opts) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.convertToPixel = function(finder, value) {
      return doConvertPixel(this, "convertToPixel", finder, value);
    };
    ECharts3.prototype.convertFromPixel = function(finder, value) {
      return doConvertPixel(this, "convertFromPixel", finder, value);
    };
    ECharts3.prototype.containPixel = function(finder, value) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.getVisual = function(finder, visualType) {
      var ecModel = this._model;
    ...
    ECharts3.prototype.getViewOfComponentModel = function(componentModel) {
      return this._componentsMap[componentModel.__viewId];
    };
    ECharts3.prototype.getViewOfSeriesModel = function(seriesModel) {
      return this._chartsMap[seriesModel.__viewId];
    };
    ECharts3.prototype._initEvents = function() {
      var _this = this;
    ...
    ECharts3.prototype.isDisposed = function() {
      return this._disposed;
    };
    ECharts3.prototype.clear = function() {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.dispose = function() {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.resize = function(opts) {
      if (this[IN_MAIN_PROCESS_KEY]) {
        if (true) {
    ...
    ECharts3.prototype.showLoading = function(name, cfg) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.hideLoading = function() {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.makeActionFromEvent = function(eventObj) {
      var payload = extend({}, eventObj);
      payload.type = eventActionMap[eventObj.type];
      return payload;
    };
    ECharts3.prototype.dispatchAction = function(payload, opt) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.prototype.updateLabelLayout = function() {
    ...
    ECharts3.prototype.appendData = function(params) {
      if (this._disposed) {
        disposedWarning(this.id);
        return;
      }
    ...
    ECharts3.internalField = function() {
...
var ECharts2 = defineComponent({
  ...
  setup(props, { attrs }) {
    ...
    function init$1(option) {
      ...
      const instance = chart.value = init2(
        root.value,
        realTheme.value,
